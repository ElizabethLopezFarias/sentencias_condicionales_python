#a mayor_a.py debe retornar un diccionario con el mes y el valor asociado siempre y cuando superen el umbral especificado. 

# Diccionario de ventas entregado
ventas = {
    "Enero": 15000,
    "Febrero": 22000,
    "Marzo": 12000,
...
# Umbral específico ingresado por el usuario
umbral_str = input("Por favor, ingresa el valor del umbral: ")

#isdigit() para verificar si el valor numérico 
